describe("Registration form", () => {
  ...
  context("Form Registration", () => {
    ...
    it("Should display error message User already exists", () => {
      ...
      cy.get("div.modal-footer button")
        ...
        .should("be.enabled")
        .click();
      cy.get("p.alert.alert-danger").should("contain.text", "User already exists");
    });
  })
  ...
  context("Validation field Name", () => {
    ...
    it("Valid name - other fields are empty", () => {
      cy.contains("Sign up").click();
      cy.get("#signupName").type("Yuliya").blur()
  ...
  context("Validation field LastName", () => {
    ...
    it("Invalid lastname - length more than 20 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupLastName").type("Awertyuiopasdfghjklzd").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("contain.text", "Last name has to be from 2 to 20 characters long")
        .should("have.css", "Color", "rgb(220, 53, 69)");
    ...
    it("Invalid lastname - not only letters", () => {
      cy.contains("Sign up").click();
      cy.get("#signupLastName").type("Yulia!").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
    ...
    it("Valid lastname - other fields are empty", () => {
      cy.contains("Sign up").click();
      cy.get("#signupLastName").type("Komerista").blur()
        .should("have.css", "border-color", "rgb(206, 212, 218)");
  ...
  context("Validation field Email", () => {
    ...
    it("Invalid Email - 1 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupEmail").type("A").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
    ...
    it("Invalid Email - length more than 20 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupEmail").type("Awertyuiopasdfghjklzd").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("contain.text", "Email is incorrect")
        .should("have.css", "Color", "rgb(220, 53, 69)");
    ...
    it("Invalid Email - not only letters", () => {
      cy.contains("Sign up").click();
      cy.get("#signupEmail").type("Yulia@").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("contain.text", "Email is incorrect")
        .should("have.css", "Color", "rgb(220, 53, 69)");
    ...
    it("Valid Email - other fields are empty", () => {
      cy.contains("Sign up").click();
      cy.get("#signupEmail").type("Yulia@gmail.com").blur()
        .should("have.css", "border-color", "rgb(206, 212, 218)");
      cy.get("button.btn.btn-primary")
        .should("be.visible")
        .should("be.disabled");
  ...
  context("Validation field Password", () => {
    it("Empty field ", () => {
      ...
      cy.get("div.invalid-feedback p").eq(0)
        ...
        .should("have.css", "Color", "rgb(220, 53, 69)");
      cy.get("#signupRepeatPassword").should("not.have.css", "border-color", "rgb(220, 53, 69)");
    });
    ...
    it("Invalid Password - length more than 16 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupPassword").type("Passwordcharacter166666677").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("have.css", "Color", "rgb(220, 53, 69)")
        .should("contain.text", "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter")
    ...
    it("Invalid Password - only letters", () => {
      cy.contains("Sign up").click();
      cy.get("#signupPassword").type("YuliaTest").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("have.css", "Color", "rgb(220, 53, 69)")
        .should("contain.text", "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter")
    ...
    it("Valid Password - other fields are empty", () => {
      cy.contains("Sign up").click();
      cy.get("#signupPassword").type("YuliaTest12345!").blur()
        .should("have.css", "border-color", "rgb(206, 212, 218)");
      cy.get("button.btn.btn-primary")
        .should("be.visible")
        .should("be.disabled");
  ...
  context("Validation field RepeatPassword", () => {
    ...
    it("Invalid RepeatPassword - 1 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupRepeatPassword").type("A").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("have.css", "Color", "rgb(220, 53, 69)")
        .should("contain.text", "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter")
    ...
    it("Invalid RepeatPassword - length more than 16 character", () => {
      cy.contains("Sign up").click();
      cy.get("#signupRepeatPassword").type("Passwordcharacter166666677").blur()
        .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("have.css", "Color", "rgb(220, 53, 69)")
        .should("contain.text", "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter")
    ...
    it("Invalid RepeatPassword - only letters", () => {
      cy.contains("Sign up").click();
      cy.get("#signupRepeatPassword").type("YuliaTest").blur()
       .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
        .should("have.css", "Color", "rgb(220, 53, 69)")
        .should("contain.text", "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter")
    ...
    it("Valid RepeatPassword - other fields are empty", () => {
      cy.contains("Sign up").click();
      cy.get("#signupRepeatPassword").type("YuliaTest12345!").blur()
       .should("have.css", "border-color", "rgb(220, 53, 69)");
      cy.get("div.invalid-feedback p").eq(0)
